...
public class general2 extends AppCompatActivity {
    Button button;
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r4.setOnCheckedChangeListener((group, checkedId) -> {
            if(checkedId==R.id.questionFourC){
                points+=5;
            }
        });
        ...
        r6.setOnCheckedChangeListener((group, checkedId) -> {
            if(checkedId==R.id.questionSixB){
                points+=5;
            }
        });
        ...
        r9.setOnCheckedChangeListener((group, checkedId) -> {
            if(checkedId==R.id.questionNineB){
                points+=5;
            }
        });
        r10.setOnCheckedChangeListener((group, checkedId) -> {
            if(checkedId==R.id.questionTenD){
                points+=5;
            }
        });
